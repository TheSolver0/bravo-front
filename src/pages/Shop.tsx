  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Solde Actuel - Amélioration du contraste et de la visibilité */}
        <Card className="py-3 px-6 bg-primary border-none flex items-center gap-4 shadow-xl shadow-primary/30 shrink-0">
          ...
          <div>
            <p className="text-[10px] fond-bold uppercase tracking-[0.15em] text-blue-90  mb-0.5">Solde actuel</p>
            <p className="text-xl fond-bold leading-none tracking-tight">
              {balance.toLocaleString()} <span className="text-sm font-medium text-blue">pts</span>
            </p>
          </div>
        </Card>
      </div>
